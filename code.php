...
if (isset($_POST["submit_update"])) {
  ...
  $sql_dlt = "DELETE FROM `st_sbject` WHERE `st_id` =  $st_id ";
    $dlt_result = mysqli_query($con,$sql_dlt);
    ...
    foreach ($code_upd as $index => $names) {
      ...
      $update2 = "INSERT INTO `st_sbject`(`st_id`, `sbj_code`, `sbj_name`)
       VALUES ('$st_id','$s_codeupd','$sb_nameupd')";
      // print_r($update2);
      // die;
...
<body>
  ...
  <div class="container">
    <!-- <div class="row">
      <div class="form-gorup col-md-6">
        ...
        <div class="form-group col-md-6">
          <a type="button" href="form.php" class="btn btn-primary" style="margin-left:700px"> ADD STUDENTS</a>
        </div>
      </div>
    </div> -->
    ...
    <div class="row form-inline">
      ...
      <a type="button" href="form.php" class="btn btn-primary"> ADD STUDENTS</a>
      </div>
    </div>
